...
namespace AForge { namespace Video { namespace FFMPEG
{
	...
	public ref class VideoFileSource // : IVideoStreamImp
	{
	public:
	/*		virtual property float Volume
		...
		virtual property float Panning
		{
			void set(float value)
			{
				throw gcnew Exception("tbi");
		...
		virtual ImageData GetCurrentFrame()
		{
			throw gcnew Exception("tbi");
		}
		*/
