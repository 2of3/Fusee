...
namespace AForge { namespace Video { namespace FFMPEG
{
	...
	public:
        ...
        /// <exception cref="Exception">A error occurred while creating new video file. See exception message.</exception>
        ...
        /// <exception cref="Exception">A error occurred while writing new video frame. See exception message.</exception>
        /// 
