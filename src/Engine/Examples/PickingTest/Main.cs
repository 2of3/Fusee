...
namespace Examples.SceneViewer
{
    ...
    public class PickingTest : RenderCanvas
    {
        ...
        public override void Init()
        {
            ...
            using (var file = File.OpenRead(@"Assets/Nobbi.fus"))
            {
        ...
        public override void RenderAFrame()
        {
            ...
            {
                // Pick test
                var pos = Input.Instance.GetMousePos();
                _sp.PickPos = pos;
                var pickResult = _scene.Children.Viserate(_sp).OrderBy(pr => pr.ScreenPos.z / pr.ScreenPos.w).First();
